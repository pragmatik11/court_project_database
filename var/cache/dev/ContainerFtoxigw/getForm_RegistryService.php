...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\AdministrativeType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\AdministrativeType']) ? $this->services['AppBundle\\Form\\AdministrativeType'] : ($this->services['AppBundle\\Form\\AdministrativeType'] = new \AppBundle\Form\AdministrativeType())) && false ?: '_'};
}, 'AppBundle\\Form\\CivilType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\CivilType']) ? $this->services['AppBundle\\Form\\CivilType'] : ($this->services['AppBundle\\Form\\CivilType'] = new \AppBundle\Form\CivilType())) && false ?: '_'};
}, 'AppBundle\\Form\\ContraventionaleType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\ContraventionaleType']) ? $this->services['AppBundle\\Form\\ContraventionaleType'] : ($this->services['AppBundle\\Form\\ContraventionaleType'] = new \AppBundle\Form\ContraventionaleType())) && false ?: '_'};
}, 'AppBundle\\Form\\PenalType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\PenalType']) ? $this->services['AppBundle\\Form\\PenalType'] : ($this->services['AppBundle\\Form\\PenalType'] = new \AppBundle\Form\PenalType())) && false ?: '_'};
